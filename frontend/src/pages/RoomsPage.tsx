...
const RoomsPage: FC = () => {
  ...
  return (
    <>
      ...
      <form className="filter" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="sort">
          ...
          <div className="sort-options">
            <button
              className={`sort__item text-semibold ${
                sort == 'priceAsc' ? 'sort__item--selected' : ''
              }`}
              onClick={() => {
            ...
            <button
              className={`sort__item text-semibold ${
                sort == 'priceDesc' ? 'sort__item--selected' : ''
              }`}
              onClick={() => {
                event?.preventDefault();
                setSort('priceDesc');
        ...
        <Button
          variant="contained"
          type="submit"
          className="filter__submit filter__item"
        >
          Show
        </Button>
      </form>
      ...
      <div className="rooms">
        {rooms?.map((room) => (
          <RoomSimpleView key={room.id} {...room} />
        ))}
      </div>
    </>
  );
